...
<html lang="en">
    <head>
        ...
        <title>theStory | Category/Foods</title>
    </head>
    <body>
        ...
        <!-- Hero -->
        <div id="foods-image" class="container-fluid">
            <div class="overlay">
                <h1 data-aos="fade-up" data-aos-once="true" class="text-center"><strong class="playfair text-white">Foods</strong></h1>
            </div>
        </div>
                ...
                <div class="col-lg-9">
                    <div class="row">
                        <?php
                            ...
                            $sql = "SELECT * FROM `posts` WHERE category_1 = 'Food' OR category_2 = 'Food' ORDER BY id DESC LIMIT 4;";
                            ...
                            $sql = "SELECT * FROM `posts` WHERE category_1 = 'Food' OR category_2 = 'Food' ORDER BY id DESC LIMIT ".$thisPageFirstResult . ',' . $resultsPerPage;
                            $result = $conn->query($sql);
                        ...
                        ?>
                        <div data-aos="fade-up" data-aos-once="true" class="col-md-4 col-lg-4 text-grey mt-3 category-post">
                        ...
                        <div id="pag-container" class="col-lg-12 text-center">
                            <ul>
                                <li class="d-inline">
                                    <a class="d-inline-block" href="http://localhost/thestory/foods/?page=<?php echo $page - 1; ?>&#food-posts">
                                ...
                                <?php endfor; ?> 
                                <li class="d-inline">
                                    <a class="d-inline-block" href="http://localhost/thestory/foods/?page=<?php echo ($_GET['page'] + 1); ?>&#food-posts">
